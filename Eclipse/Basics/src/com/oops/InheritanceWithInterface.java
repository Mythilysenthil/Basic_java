...
public class InheritanceWithInterface implements SearchbyTitle, SearchbyGenre {
	...
	public static void main(String[] args) {
		...
		InheritanceWithInterface C = new InheritanceWithInterface();
		...
		Movie M3 = new Movie("CCC","Dramanz",3,"English",date,"Italy","Action");
		MovieList.add(M3);
